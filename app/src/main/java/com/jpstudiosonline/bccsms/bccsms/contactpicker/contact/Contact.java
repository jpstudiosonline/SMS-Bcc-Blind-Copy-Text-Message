...
public interface Contact extends ContactElement {
    ...
    /**
     * @see com.jpstudiosonline.masstext.contactpicker.contact.Contact#getEmail(int)
    ...
    /**
     * @see com.jpstudiosonline.masstext.contactpicker.contact.Contact#getPhone(int)
    ...
    /**
     * @see com.jpstudiosonline.masstext.contactpicker.contact.Contact#getAddress(int)
